...
{
    public partial class frmFuncioarios : Form
    {
        ...
        public frmFuncioarios(string nome)
        {
            InitializeComponent();
            desabilitarCampos();
            txtNome.Text = nome;
        ...
        private void frmFuncioarios_Load(object sender, EventArgs e)
        {
